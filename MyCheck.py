...
URL = "http://api.openweathermap.org/data/2.5/weather"                #ссылка на json данные, по которой получаем погоду
URLRATE = "https://www.cbr-xml-daily.ru/daily_json.js"                #ссылка на json данные, по которой получаем курс валют
